	...
	<div id="content" class="full-width">
		...
		<div id="post-404page" class="post">
			<div class="post-content">
				<div class="title">
					<h2 class="entry-title"><?php echo __('Oops, This Page Could Not Be Found!', 'Avada'); ?></h2><div class="title-sep-container"><div class="title-sep"></div></div>
				</div>
				<div class="error_page">
					...
					<div class="one_third last">
						...
						<p><img src="http://i.imgur.com/62wcKsm.png"></p>
